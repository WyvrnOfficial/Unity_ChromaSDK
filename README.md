...
The `ChromaAnimationAPI` class provides a wrapper for the `RzChromatic` Library. The wrapper for the API can be found at `Packages\RazerChromaSDK\Runtime\ChromaAnimationAPI.cs`.
